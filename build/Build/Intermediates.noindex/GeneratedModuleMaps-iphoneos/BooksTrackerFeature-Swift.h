...
// Generated by Apple Swift version 6.2 (swiftlang-6.2.3.3.20 clang-1700.6.3.2)
#ifndef BOOKSTRACKERFEATURE_SWIFT_H
#define BOOKSTRACKERFEATURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BooksTrackerFeature",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC19BooksTrackerFeature24WebSocketProgressManager")
@interface WebSocketProgressManager : NSObject <NSURLSessionWebSocketDelegate>
...
@class NSData;
@interface WebSocketProgressManager (SWIFT_EXTENSION(BooksTrackerFeature))
