...
public final class FeatureFlags: Sendable {
    ...
    public var useV2CSVImport: Bool {
        get {
            UserDefaults.standard.object(forKey: "feature.useV2CSVImport") as? Bool ?? false
        }
        set {
    ...
    public func resetToDefaults() {
        ...
        useV2CSVImport = false // Default V2 SSE disabled
        #if DEBUG
        print("✅ FeatureFlags reset to defaults (tabBarMinimize: true, coverSelection: auto, canonicalEnrichment: true, useV2CSVImport: false)")
        #endif
    }
}
